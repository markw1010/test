...
def drawApple():
    for apple in appleCoordination:
        coordination = [apple[0] * elementSize, apple[
            1] * elementSize]  # The coordinates for the apple spawn. apple[0] = x coordinate. apple[1] = y coordinate.
        pygame.draw.rect(screen, white, (coordination[0], coordination[1], elementSize, elementSize),
                         1)  # spawn the apple
